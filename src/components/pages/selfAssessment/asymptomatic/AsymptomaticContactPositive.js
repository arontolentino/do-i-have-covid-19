...
class AsymptomaticContactPositive extends Component {
	state = {
		question: ''
	};
	...
	componentDidMount() {
		...
		butter.page
			.retrieve('*', 'asymptomatic-contact-positive')
			.then(resp => {
				...
				<main className="main">
					<div className="secondary-wrapper">
						...
						<div className="btn-container">
							<BtnQuiz link="/self-assessment/asymptomatic-travel-positive">
								Yes
							</BtnQuiz>
							<BtnQuiz link="/self-assessment/asymptomatic-positive">
								No
							</BtnQuiz>
						</div>
					</div>
...
export default AsymptomaticContactPositive;
