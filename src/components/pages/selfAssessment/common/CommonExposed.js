...
class CommonExposed extends Component {
	state = {
		question: ''
	};
				...
				<main className="main">
					<div className="secondary-wrapper">
						...
						<div className="btn-container">
							<BtnQuiz link="/self-assessment/common-positive">Yes</BtnQuiz>
							<BtnQuiz link="/self-assessment/common-travel">No</BtnQuiz>
						</div>
					</div>
				</main>
